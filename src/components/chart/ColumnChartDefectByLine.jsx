...
function ColumnChartDefectByLine() {
        ...
        <div className="sub-card-glass flex items-start flex-wrap">
            <div className="w-full flex  justify-between items-center flex-wrap">
                <div className="flex items-center gap-2.5">
                    ...
                    <p className="text-white">Production Defect by Line <br/>
                ...
                <div className="flex justify-end">
                    ...
                    >
                        <Tab label="Defect pcs" value="Defect" />
...
export default ColumnChartDefectByLine;